...
public class Main {
    ...
    public static void VisualizarResponsavelDepartamento(int fkFuncionario) { // individual gus
        FuncionarioRepositorio repositorioFuncionario = new FuncionarioRepositorio(conn);
        Funcionario responsavel = repositorioFuncionario.buscarFuncionarioResponsavelDepartamento(fkFuncionario);
